...
`git clone https://github.com/Conrage/watch-fpl.git`
...
Você pode criar uma issue [aqui](https://github.com/Conrage/watch-fpl/issues), mas, lembre-se de ser claro e informar o máximo de detalhes possíveis.
